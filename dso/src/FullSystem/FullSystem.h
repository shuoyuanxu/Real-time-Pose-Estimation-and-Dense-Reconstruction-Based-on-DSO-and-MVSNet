...
public:
	...
	void addActiveFrame(ImageAndExposure* image, cv::Mat img_bgr, int id);
	SE3 get_curSE3(); //obtain current states
	...
	// Intermediate variable to be published thru ROS
	std::deque<std::vector<OutputFrame>> slidingWindows_Frames;
